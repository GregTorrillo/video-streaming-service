...
const SearchModal = (props) => {
	...
	// 			`https://api.themoviedb.org/3/discover/movie?primary_release_year=2021&api_71bbad38cd74cecf8e7ec1d5e478a67a&language=en-US`,
	// 		);
	...
	const handleInput = async (e) => {
		try {
			...
			let searchData = await axios.get(
				`https://api.themoviedb.org/3/search/multi?query=${e.target.value}&api_key=71bbad38cd74cecf8e7ec1d5e478a67a&language=en-US`,
			);
			setSearchData(
