        ...
        <div className={`search-modal ${globalState.searchOpen ? 'search-modal--active' : ''}`}>
            ...
            <div className="search-modal__thumbnails">
                <div className='search-modal__thumbnail'>
                    <img src='https://cdn11.bigcommerce.com/s-ydriczk/images/stencil/1280x1280/products/88997/93196/Avengers-Endgame-Final-Style-Poster-buy-original-movie-poster-at-starstills__42370.1563973516.jpg?c=2?imbypass=on' />
